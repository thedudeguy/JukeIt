...
public class Sound {
	...
	public void play() {
		if ( location == null || range <= 0) {
			SpoutManager.getSoundManager().playGlobalCustomSoundEffect(JukeIt.getInstance(), sound.getSoundFileName(), notify);
		} else {
			play(location);
		}
	}
	...
	public void play(Location location) {
		...
		SpoutManager.getSoundManager().playGlobalCustomSoundEffect(JukeIt.getInstance(), sound.getSoundFileName(), notify, location, range, volume);
